...
public class OrdersFragment extends Fragment {
    ...
    private FloatingActionButton fab_voice_orders;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fab_voice_orders = view.findViewById(R.id.fab_voice_orders);
        fab_voice_orders.setOnClickListener(new View.OnClickListener() {
            @Override
